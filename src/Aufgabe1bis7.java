...
public class Aufgabe1bis7 {
        public static void main (String[] args) {

            // Aufgabe 1:
            String Uni = "Aufgabe 1: ESOP ist super";
            System.out.println(Uni);

            // Aufgabe 2:
            int fuenf = 5;
            System.out.println("Aufgabe 2: Hoffentlich ist die Note nicht "+fuenf);

            // Aufgabe 3:
            String Di = "Das ist";
            String Ez = " eine Zeichenkette.";
            String zusammen;
            zusammen = Di + Ez;
            ...
            double fünf = 1.00e-3; // 10^-3 ... also 0.001
